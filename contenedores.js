class Contenedores {
  ...
  completarVariables(){
    ...
    this.AtituloBoton1 = "Machos";
    this.AdescripcionBoton1Linea1 = "El macho tiene una cabeza rojo-fuego mientras";
    this.AdescripcionBoton1Linea2 = "que la cabeza de la hembra es negra con ";
    this.AdescripcionBoton1Linea3 = "una cresta recurvada distintiva.";
    ...
    this.AtituloBoton2 = "Nidos";
    this.AdescripcionBoton2Linea1 = "Los carpinteros negros requieren de bosques ";
    this.AdescripcionBoton2Linea2 = "antiguos, con árboles adultos que permitan la ";
    this.AdescripcionBoton2Linea3 = "excavación de su cavidad para poder hacer nidos.";
    ...
    this.Btitulo = "Huemul";
    this.BdescripcionLinea1= "El huemul, güemul o ciervo sur andino, es un mamífero en";
    this.BdescripcionLinea2= "peligro de extinción perteneciente a la familia Cervidae que";
    this.BdescripcionLinea3= "habita en la cordillera de los Andes de Chile aproximadamente";
    this.BdescripcionLinea4= "en un 75 % a nivel poblacional, y Argentina en un 25 %. Es el ";
    this.BdescripcionLinea5= "cérvido más austral del planeta";
    // boton
    this.Br = 215;
    this.Bg = 160;
    this.Bb = 88;
    this.BimgBoton1 = loadImage("img/BimgBoton1.jpg");
    this.BtituloBoton1 = "Peligro de extincion";
    this.BdescripcionBoton1Linea1 = "Se encuentra categorizada como especie en";
    this.BdescripcionBoton1Linea2 = "peligro de extinción, debido principalmente";
    this.BdescripcionBoton1Linea3 = "a la transformación de su hábitat y a la ";
    this.BdescripcionBoton1Linea4 = "caza mayor.";
  ...
  // grafico
    ...
    this.Ctitulo = "Puma";
    this.CdescripcionLinea1= "Es un felino de gran tamaño, presenta una forma esbelta, cabeza";
    this.CdescripcionLinea2= "ancha, con orejas redondeadas y cola larga, del mismo grosor en";
    this.CdescripcionLinea3= "toda su longitud";
    ...
    this.CtituloBoton1 = "Piel";
    this.CdescripcionBoton1Linea1 = "En el adulto el pelaje es suave, corto y de";
    this.CdescripcionBoton1Linea2 = "color uniforme, mientras que en las crías ";
    this.CdescripcionBoton1Linea3 = "presenta un moteado muy oscuro durante ";
    this.CdescripcionBoton1Linea4 = "primeros meses de vida";
